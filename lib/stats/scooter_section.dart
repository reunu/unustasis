      ...
      child: Column(
        children: [
          ...
          if (!connected)
            ListTile(
              title:
                  Text(FlutterI18n.translate(context, "stats_last_ping_title")),
              subtitle: Text(FlutterI18n.translate(context, "stats_last_ping",
                  translationParams: {
              ...
              children: [
                if (connected)
                  TextButton.icon(
                    ...
                    label: Text(
                      FlutterI18n.translate(context, "settings_disconnect")
                          .toUpperCase(),
