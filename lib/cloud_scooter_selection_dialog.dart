...
class ScooterSelectionDialog extends StatelessWidget {
  ...
  String _getAssignmentStatus(
      BuildContext context, Map<String, dynamic> scooter) {
    ...
    return FlutterI18n.translate(context, "cloud_assigned_to_scooter",
        translationParams: {"name": matchingScooters.first.name});
  }

  Future<bool> _confirmReassignment(
      BuildContext context, Map<String, dynamic> scooter) async {
    ...
    return await showDialog<bool>(
          ...
          builder: (BuildContext context) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Text(FlutterI18n.translate(context, "cloud_reassign_message",
            ...
            actions: [
              TextButton(
                ...
                child: Text(
                    FlutterI18n.translate(context, "cloud_reassign_cancel")),
              ),
              TextButton(
                onPressed: () => Navigator.pop(context, true),
                child: Text(
                    FlutterI18n.translate(context, "cloud_reassign_confirm")),
              ),
            ],
          ),
        ) ??
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final bool isCurrentlyAssigned =
                scooter['id'] as int == currentlyAssignedId;
            final deviceIds = scooter['device_ids'] as Map<String, dynamic>?;
            final bool isAssignedToOtherDevice = deviceIds != null &&
              ...
              leading: Stack(
                children: [
                  Image.asset(
                    ...
                    colorBlendMode:
                        isAssignedToOtherDevice ? BlendMode.saturation : null,
                  ),
