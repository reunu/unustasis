...
import com.unumotors.ossapp.R.drawable.ic_lock
import com.unumotors.ossapp.R.drawable.ic_unlock
import com.unumotors.ossapp.R.drawable.ic_lock_disabled
import com.unumotors.ossapp.R.drawable.ic_battery_0
import com.unumotors.ossapp.R.drawable.ic_battery_10
import com.unumotors.ossapp.R.drawable.ic_battery_25
import com.unumotors.ossapp.R.drawable.ic_battery_40
import com.unumotors.ossapp.R.drawable.ic_battery_60
import com.unumotors.ossapp.R.drawable.ic_battery_75
import com.unumotors.ossapp.R.drawable.ic_battery_85
import com.unumotors.ossapp.R.drawable.ic_battery_100
import com.unumotors.ossapp.R.drawable.ic_location
import com.unumotors.ossapp.R.drawable.ic_location_disabled
import com.unumotors.ossapp.R.drawable.ic_seatbox
import com.unumotors.ossapp.R.drawable.ic_seatbox_open
import com.unumotors.ossapp.R.drawable.ic_seatbox_disabled
import com.unumotors.ossapp.R.drawable.base_0
import com.unumotors.ossapp.R.drawable.base_1
import com.unumotors.ossapp.R.drawable.base_2
import com.unumotors.ossapp.R.drawable.base_3
import com.unumotors.ossapp.R.drawable.base_4
import com.unumotors.ossapp.R.drawable.base_5
import com.unumotors.ossapp.R.drawable.base_6
import com.unumotors.ossapp.R.drawable.base_7
import com.unumotors.ossapp.R.drawable.base_8
import com.unumotors.ossapp.R.drawable.base_9
...
class LockAction : ActionCallback {
    override suspend fun onAction(context: Context, glanceId: GlanceId, parameters: ActionParameters) {
        val backgroundIntent = HomeWidgetBackgroundIntent.getBroadcast(context, Uri.parse("unu://lock"))
...
class UnlockAction : ActionCallback {
    override suspend fun onAction(context: Context, glanceId: GlanceId, parameters: ActionParameters) {
        val backgroundIntent = HomeWidgetBackgroundIntent.getBroadcast(context, Uri.parse("unu://unlock"))
        backgroundIntent.send()
    }
}
...
class OpenSeatAction : ActionCallback {
    override suspend fun onAction(context: Context, glanceId: GlanceId, parameters: ActionParameters) {
        val backgroundIntent = HomeWidgetBackgroundIntent.getBroadcast(context, Uri.parse("unu://openseat"))
        backgroundIntent.send()
    }
}
